...
import { focusElement, getFocusedElement, getNextElementFromDirection } from './dom'
...
function handleKeyboardNavigation(keyPressed: Directions, $focusedEl: HTMLElement) {
